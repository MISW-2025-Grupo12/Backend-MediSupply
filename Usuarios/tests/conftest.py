...
@pytest.fixture
def usuarios_urls():
    """Fixture específico para URLs de usuarios"""
    return {
        'proveedores': f"{BASE_URLS['usuarios']}{API_ROUTES['usuarios']['proveedores']}",
        'vendedores': f"{BASE_URLS['usuarios']}{API_ROUTES['usuarios']['vendedores']}",
        'clientes': f"{BASE_URLS['usuarios']}{API_ROUTES['usuarios']['clientes']}"
    }
...
def get_usuarios_url(endpoint: str) -> str:
    """Obtiene la URL completa para un endpoint de usuarios"""
    return f"{BASE_URLS['usuarios']}{API_ROUTES['usuarios'][endpoint]}"
